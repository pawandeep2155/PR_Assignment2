% Read Data as a Matrix from text file
data = load('3_ls.txt');
...
mean_class_1 = mean_calculate(data(1:class_rows,:));
mean_class_2 = mean_calculate(data(class_rows+1:2*class_rows,:));
mean_class_3 = mean_calculate(data(2*class_rows+1:num_of_rows,:));
